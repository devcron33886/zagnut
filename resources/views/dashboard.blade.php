                            ...
                            <table id="myTable" class="min-w-full divide-y divide-gray-300">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-3 bg-green-400 py-4 text-sm text-gray-900">{{ $work->formattedPayOut() }}</td>   
                                    </tr>
                                @endforeach
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{ Cknow\Money\Money::RWF($total_percentage) }}</td>
                                    </tr>
                                </tfoot>
                            </tbody>
                        </table>
